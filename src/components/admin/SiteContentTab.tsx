...
const PAGE_LABELS: Record<string, string> = {
  ...
  "buyers-guide": "H.O.M.E. Buyers Guide",
  ebook: "Ebook Download",
  explainers: "Explainers (Index)",
  "explainers-nht": "Explainer: NHT",
  "explainers-buyer": "Explainer: Buyer",
  "explainers-seller": "Explainer: Seller",
  "explainers-costs": "Explainer: Costs",
  "explainers-banker": "Explainer: Banker",
  "explainers-agent": "Explainer: Agent",
  "explainers-surveyor": "Explainer: Surveyor",
...
const PAGE_PATHS: Record<string, string> = {
  ...
  "explainers-nht": "/explainers/nht",
  "explainers-buyer": "/explainers/buyer",
  "explainers-seller": "/explainers/seller",
  "explainers-costs": "/explainers/costs",
  "explainers-banker": "/explainers/banker",
  "explainers-agent": "/explainers/agent",
  "explainers-surveyor": "/explainers/surveyor",
  glossary: "/glossary",
  directory: "/directory",
  privacy: "/privacy",
  terms: "/terms",
