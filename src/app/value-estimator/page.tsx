        ...
        <section style={{
          ...
          <div style={{ maxWidth: 780, margin: "0 auto", position: "relative" }}>
            ...
            <p style={{
              ...
              Jamaica market benchmarks. Not a formal valuation — for a certified report,
              speak with a licensed valuator.
            </p>
            <div style={{ marginTop: 28, display: "flex", gap: 8, flexWrap: "wrap" }}>
              {[
                { icon: "🏡", label: "13 parishes covered" },
                { icon: "📊", label: "Mid-2026 benchmarks" },
                { icon: "⚡", label: "Instant estimate" },
              ].map(b => (
                <span key={b.label} style={{
                  display: "inline-flex", alignItems: "center", gap: 6,
                  background: "rgba(255,255,255,0.08)",
                  border: "1px solid rgba(200,166,92,0.2)",
