...
const ROLES: Role[] = [
  {
    ...
    moments: [
      ...
      },
      {
        ...
        body: "Before you spend a cent, we search the title. We're checking who actually owns this property — and what's sitting on it. Caveats, liens, undisclosed mortgages, outstanding property tax. If something's off, you hear about it before it costs you.",
      },
      {
        headline: "The contract lands on our desk.",
        body: "The seller's lawyer sends the Agreement for Sale. We read every line. Risky clauses get flagged, completion dates get fixed, your deposit goes into a secure client account — not the vendor's hands. We don't sign off until it protects you.",
      },
      {
      ...
      },
      {
        ...
        body: "A Duplicate Certificate of Title with your name on it — registered, clean, yours. The transaction is done. The property is protected.",
      },
    ],
  },
  {
    id: "seller",
    label: "Seller",
    tagline: "Someone wants to buy your property. Before you agree to anything — read this.",
    ...
    moments: [
      ...
      },
      {
        ...
        body: "We calculate what's owed on the agreed price. Revenue stamps, compliance certificate, all NLA filings — taken care of. You receive a clear breakdown of every fee before anything moves.",
      },
      {
  ...
  },
  {
    ...
    moments: [
      ...
      },
      {
        ...
        body: "With full legal coverage and a complete professional team, clients move from first enquiry to registered title — and you're the professional who helped make it happen.",
      },
    ],
  },
  {
    ...
    moments: [
      {
        headline: "You talk to Owen first.",
        body: `A ${CONSULT_DURATION_MIN}-minute call (${CONSULT_FEE_DISPLAY}). No judgment — just clarity on what the process involves, how long it takes, and what your rights are before anything is filed.`,
      },
      {
      ...
      },
      {
        ...
        body: "We prepare and file the divorce petition in the Supreme Court of Jamaica. Grounds, timelines, and next steps are explained at every stage — you're never left wondering where things stand.",
      },
      {
      ...
      },
      {
        ...
        body: "The marriage is legally dissolved. Every order is in writing. You leave with a clear record of what's been agreed — and the certainty to move forward.",
      },
    ],
  },
  {
    ...
    moments: [
      {
        ...
        body: `A ${CONSULT_DURATION_MIN}-minute consultation (${CONSULT_FEE_DISPLAY}). We map your assets — property, accounts, business interests — and the people or causes you want to provide for. Simple to complex, we've handled it.`,
      },
      {
        headline: "Your Will is drafted.",
        body: "Every instruction is captured precisely: who receives what, under what conditions, and who you trust to carry it out. We flag anything that could create a dispute or delay — and fix it before it's signed.",
      },
      {
        headline: "It's executed properly.",
        body: "A Will that isn't correctly signed and witnessed is invalid under Jamaican law. We manage the execution — witnesses, formalities, everything — so there's no question about its validity.",
      },
      {
      ...
      {
        headline: "When the time comes — Probate.",
    ...
    moments: [
      {
        ...
        body: `A consultation (${CONSULT_FEE_DISPLAY}) to understand your structure — sole trader, limited company, or partnership. We register with the Companies Office of Jamaica, draft your foundational documents, and get you operating on solid ground.`,
      },
      {
        headline: "Your contracts say what you mean.",
        body: "Service agreements, supplier terms, employment contracts, shareholder agreements — reviewed or drafted so they protect you, not just the other side. Plain language, Jamaican law, no ambiguity.",
      },
      {
        headline: "You stay compliant.",
        body: "Annual returns, regulatory filings, changes to directors or share structure — Ferguson Law keeps your company in good standing so you can focus on running it.",
      },
      {
        headline: "Commercial deals are handled.",
        body: "Joint ventures, acquisitions, leases, licensing arrangements — we review every material agreement before you sign. Nothing moves until the terms are right for you.",
      },
      {
        headline: "You have counsel when it matters.",
        body: "Disputes, demand letters, regulatory queries — you're not handling them alone. Ferguson Law is your legal anchor for as long as you're in business.",
      },
    ],
  },
  {
    ...
    tagline: "Your talent is your asset. Here's how Ferguson Law makes sure it earns — and stays protected.",
    moments: [
      {
        headline: "We understand what you're building.",
        body: `A ${CONSULT_DURATION_MIN}-minute call (${CONSULT_FEE_DISPLAY}). Whether you're a professional athlete, a recording artist, a content creator, or a brand — we identify where you're exposed and where you're leaving money on the table.`,
      },
      {
        headline: "Your contracts are read before you sign.",
        body: "Representation agreements, sponsorship deals, performance contracts, record deals — we go line by line. Unfair clauses get flagged. Royalty splits, image rights, exclusivity windows, and termination terms are negotiated in your favour.",
      },
      {
      ...
      },
      {
        ...
        body: "Who can use your name, your face, your performance — and under what terms and for how long. Ferguson Law drafts and negotiates the agreements that govern it.",
      },
      {
        headline: "You have legal cover going forward.",
        body: "Career transitions, new deals, disputes with clubs, labels, or brands — you have counsel who understands the industry and the law. Nothing gets signed without us seeing it first.",
      },
    ],
  },
];
          ...
          <div style={S.pillars}>
            {[
              ...
              },
              {
                ...
                d: "Transfer tax, stamp duty, legal fees, AML requirements — you know what's coming before anything moves.",
              },
              {
